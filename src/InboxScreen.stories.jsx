...
// The @storybook/test package replaces the @storybook/jest and @storybook/testing-library testing packages,
// offering a smaller bundle size and a more straightforward API based on the Vitest package.
...
export const PinTask = {
  ...
  // For Interaction Tests - Check Interactions Panel in Storybook
